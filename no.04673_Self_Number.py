...
# 재귀 함수로 만들 것.
# 각 자리수를 구해 원 숫자와 합친 수.
# num + ((num // 10000) + ((num // 1000) % 10) + ((num // 100) % 10) + ((num // 10) % 10) + (num % 10)

def self_num(lists, num, ct):
    if num >= 10000:
        return
    if ct != 0:
        lists[num] = 1
    ct = 1
    self_num(lists, num + ((num % 10000) // 1000) + ((num % 1000) // 100) + ((num % 100) // 10) + (num % 10), ct)
